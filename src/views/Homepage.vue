...
<template>
    <header id="hero">
        <div class="hero bg-center bg-cover bg-fixed h-[700px] py-40 px-[100px] text-white">
            <p class="text-5xl mb-10 w-1/2">WE CREATED & DEVELOP BRAND WITH PURPOSES</p>
            <p class="text-sm w-1/3">We create brand with purposes & clear vision specialized in create, develop & maintain reputable Brands</p>
    ...
    <img src="https://firebasestorage.googleapis.com/v0/b/kalih-165ab.appspot.com/o/SBI%20Logo%20Full.png?alt=media&token=092f872c-d31d-4bd3-a96e-c4157b622009" alt="" class=" absolute right-5 top-[28rem] w-[25rem] z-0">
    <section class="flex py-7">
        ...
        <div class="w-1/2 flex justify-end">
            <img src="https://firebasestorage.googleapis.com/v0/b/kalih-165ab.appspot.com/o/Asset%203.png?alt=media&token=03b82cd1-183a-430f-98ce-474b6e369e64" class="w-1/2 z-[1]" alt=""/>
        </div>
    </section>
    <section class="flex">
        <div class=" flex w-2/3 text-sm">
            <div class="w-1/4 p-10 bg-[#fffff5]">
                <p class="text-[#34513f] text-4xl">3424</p>
                <p>Lorem ipsum dolor, sit amet</p>
            </div>
            <div class="w-1/4 p-10 bg-[#edecda]">
                <p class="text-[#34513f] text-4xl">3424</p>
                <p>Lorem ipsum dolor, sit amet</p>
            </div>
            <div class="w-1/4 p-12 bg-[#fffff5]">
                <p class="text-[#34513f] text-4xl">3424</p>
                <p>Lorem ipsum dolor, sit amet</p>
            </div>
            <div class="w-1/4 p-10 bg-[#34513f] text-white">
    ...
    <section class="flex">
        ...
        <div class="w-[70rem]">
            <div class="flex gap-14 px-10">
                <div class="w-1/3 py-16 text-4xl text-[#34513f] font-semibold">
                ...
                <div class="w-1/2 py-16">
                    ...
                    <div class="flex text-white mt-10 gap-10">
            ...
            <div class="flex">
                <div class="w-1/2 h-[19.4rem] bg-cover bg-center bg-no-repeat" v-bind:style="{ backgroundImage: 'url(' + image1 + ')' }">
                </div>
    ...
    <section class="flex px-10 py-14">
        <div class="w-[25rem] h-[25rem] bg-cover bg-bottom" v-bind:style="{ backgroundImage: 'url(' + image3 + ')' }">
        </div>
        <div class="px-10">
